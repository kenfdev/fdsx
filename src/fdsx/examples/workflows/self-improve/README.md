...
- **Linting** — lint rule gaps, missing rule sets, formatter configuration
- **Type checking** — type checker strictness, untyped code detection
...
- **Developer experience** — task runners, development setup
